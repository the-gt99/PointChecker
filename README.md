...
Где $points_x - это массив X кординат всех точек; <br>
$points_y - это массив Y кординат всех точек; <br>
$all_Line - это параметр принимающий значения (1/0). При активации ($all_Line = 1) функция заполнит массив free_arr и позволит в позже найти все линии максимальной длинны. <br>
...
Где $points_x - это массив X кординат всех точек; <br>
$points_y - это массив Y кординат всех точек; <br>
$all_Triangle - это параметр принимающий значения (1/0). При активации ($all_Line = 1) функция заполнит массив free_arr и позволит в позже найти все линии максиальной длинны. <br>
